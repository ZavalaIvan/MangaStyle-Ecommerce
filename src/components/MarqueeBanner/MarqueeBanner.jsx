    ...
    <section className="marquee-banner" ref={marqueeBannerRef}>
      <div className="marquees">
        <div className="marquee-header marquee-header-1" ref={marquee1Ref}>
          <h1>Playeras anime con graficas que si levantan el outfit</h1>
        </div>
        <div className="marquee-header marquee-header-2" ref={marquee2Ref}>
          <h1>Drops limitados, arte manga y vibra streetwear</h1>
        </div>
      </div>
      <div className="banner">
        <div className="banner-content">
          ...
          <Copy>
            <h4>Graficas inspiradas en anime para uso diario</h4>
          </Copy>
        </div>
