    ...
    <section className="cta" ref={ctaRef}>
      <div className="container">
          ...
          <div className="cta-col-copy">
            <Copy>
              <p className="bodyCopy sm">
                Cada drop combina comodidad, arte anime y una direccion visual
                pensada para destacar en calle y contenido.
              </p>
            </Copy>
          </div>
        </div>
        <div className="cta-col">
          <div className="cta-header">
            <Copy>
              <h3>Explora el drop completo de MangaStyle</h3>
            </Copy>
          </div>
      ...
      <div className="container">
        <div className="cta-main-copy">
          <div className="btn">
            <Copy type="flicker">
              <Link href="/wardrobe">Entrar al catalogo</Link>
            </Copy>
          </div>
        </div>
      </div>
