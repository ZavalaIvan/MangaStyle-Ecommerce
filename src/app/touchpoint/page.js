          ...
          <div className="contact-hero-col contact-hero-copy">
            <div className="contact-header">
              <Copy animateOnScroll={false} delay={0.75}>
                <h3>Hablemos de pedidos, colaboraciones o el siguiente drop.</h3>
              </Copy>
            </div>
            <div className="contact-meta">
              ...
              <div className="contact-meta-block">
                <Copy animateOnScroll={false} delay={1.1}>
                  <p className="bodyCopy">Pedidos y envios</p>
                </Copy>
                <Copy animateOnScroll={false} delay={1.2}>
                  <h4>orders@mangastyle.store</h4>
                </Copy>
              </div>
            </div>
          </div>
      ...
      <section className="contact-callout" ref={calloutRef}>
        <div className="container">
          <div className="contact-callout-header">
            ...
            <Copy type="flicker">
              <p>
                Recibe nuevos drops, preventas y restocks de playeras anime
                antes que nadie.
              </p>
            </Copy>
            <Copy>
              <h1>Conectate a la comunidad MangaStyle</h1>
            </Copy>
