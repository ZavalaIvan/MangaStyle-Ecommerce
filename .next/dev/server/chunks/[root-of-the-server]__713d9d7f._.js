...
async function GET(_, context) {
    try {
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$printful$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["printfulFetch"])(`/store/products/${id}`);
        const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$printful$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizePrintfulProduct"])(data);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            product
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__713d9d7f._.js.map