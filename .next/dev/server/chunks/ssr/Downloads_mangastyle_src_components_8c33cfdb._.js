module.exports = [
"[project]/Downloads/mangastyle/src/components/Orb/Orb.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/mangastyle/node_modules/three/examples/jsm/controls/OrbitControls.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const Orb = ({ totalImages = 30, totalItems = 60, baseWidth = 1, baseHeight = 0.6, sphereRadius = 5, verticalOffset = 0.3 })=>{
    ...
    const sceneRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [isReady, setIsReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const meshes = [];
        const scene = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Scene"]();
        const orbGroup = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Group"]();
        orbGroup.position.y = -verticalOffset;
        scene.add(orbGroup);
        sceneRef.current = scene;
        const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerspectiveCamera"](75, window.innerWidth / window.innerHeight, 0.1, 1000);
        camera.position.z = 10;
        const renderer = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WebGLRenderer"]({
            antialias: true,
            alpha: true,
        ...
        renderer.outputColorSpace = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SRGBColorSpace"];
        containerRef.current.appendChild(renderer.domElement);
        const controls = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OrbitControls"](camera, renderer.domElement);
        ...
        ctx.fillStyle = "white";
        ctx.fill();
        const sharedAlphaMap = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CanvasTexture"](canvas);
        const textureLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextureLoader"]();
        ...
        const loadImageMesh = (phi, theta)=>{
            textureLoader.load(getRandomImagePath(), (texture)=>{
                ...
                texture.colorSpace = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SRGBColorSpace"];
                texture.generateMipmaps = true;
                texture.minFilter = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LinearMipmapLinearFilter"];
                texture.magFilter = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LinearFilter"];
                const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlaneGeometry"](width, height);
                const material = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MeshBasicMaterial"]({
                    map: texture,
                    side: __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DoubleSide"],
                    transparent: true,
                    alphaMap: sharedAlphaMap,
                    depthWrite: true,
                    depthTest: true
                });
                const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
...
//# sourceMappingURL=Downloads_mangastyle_src_components_8c33cfdb._.js.map