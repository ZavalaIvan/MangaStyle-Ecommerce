...
"[project]/Downloads/mangastyle/src/app/unit/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Unit() {
    _s();
    const heroRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const activeMinimapIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const [relatedProducts, setRelatedProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$src$2f$store$2f$cartStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])({
        "Unit.useCartStore[addToCart]": (state)=>state.addToCart
    }["Unit.useCartStore[addToCart]"]);
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const currentProduct = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$src$2f$app$2f$wardrobe$2f$products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].find((p)=>p.name === "Ronin Chapter Tee") || __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$src$2f$app$2f$wardrobe$2f$products$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"][14];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Unit.useEffect": ()=>{
            const shuffled = [
                ...
                "Unit.useEffect.shuffled": ()=>0.5 - Math.random()
            }["Unit.useEffect.shuffled"]);
        ...
        "Unit.useEffect": ()=>{
            if (pathname === "/unit") {
                ...
                const timer = setTimeout({
                    "Unit.useEffect.timer": ()=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].refresh();
                    }
                }["Unit.useEffect.timer"], 150);
                return ({
                    "Unit.useEffect": ()=>clearTimeout(timer)
                })["Unit.useEffect"];
            }
        }
    }["Unit.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Unit.useEffect": ()=>{
            const handleScrollToTop = {
                "Unit.useEffect.handleScrollToTop": ()=>{
                    window.scrollTo(0, 0);
                    setTimeout({
                        "Unit.useEffect.handleScrollToTop": ()=>{
                            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].refresh();
                        }
                    }["Unit.useEffect.handleScrollToTop"], 150);
                }
            }["Unit.useEffect.handleScrollToTop"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"])({
        "Unit.useGSAP": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(snapshots[0], {
                y: "0%",
                scale: 1
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(minimapImages[0], {
                scale: 1.25
            });
            for(let i = 1; i < totalImages; i++){
                __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(snapshots[i], {
                    y: "100%",
                    scale: 1
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(minimapImages[i], {
                    scale: 1
                });
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].create({
                ...
                onUpdate: {
                    "Unit.useGSAP": (self)=>{
                        ...
                        for(let i = 1; i < totalImages; i++){
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(snapshots[i - 1], {
                                scale: scaleValue
                            });
                        ...
                        if (currentActiveIndex !== activeMinimapIndex.current) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(minimapImages[currentActiveIndex], {
                                scale: 1.25,
                                duration: 0.3,
                                ease: "power2.out"
                            });
                            for(let i = 0; i < currentActiveIndex; i++){
                                __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(minimapImages[i], {
                                    scale: 0,
                                    duration: 0.3,
                                    ease: "power2.out"
                                });
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {}, void 0, false, {
                                                    fileName: "[project]/Downloads/mangastyle/src/app/unit/page.js",
                                                    lineNumber: 183,
                                                    columnNumber: 19
                                                }, this)
...
_s(Unit, "SktTT3sYs9YFqUrwlJLBCNOZ+fY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$src$2f$store$2f$cartStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$mangastyle$2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"]
...
_c = Unit;
var _c;
__turbopack_context__.k.register(_c, "Unit");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Downloads_mangastyle_src_2749fd1c._.js.map